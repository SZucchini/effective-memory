...
if not args.evaluate:
    ...
    while epoch < args.epochs:
        ...
        for cameras_train, batch_3d, batch_2d,in train_generator.next_epoch():
            ...
            # get bone length and direction
            inputs_3d_length, inputs_3d_bonedir = getbone_unified(inputs_3d, boneindex)
            predicted_3d_length, predicted_bonedir = getbone_unified(predicted_3d_pos, boneindex)
            
            loss_length = args.wl*torch.pow(inputs_3d_length.mean(1) - predicted_3d_length.mean(1),2).mean()
